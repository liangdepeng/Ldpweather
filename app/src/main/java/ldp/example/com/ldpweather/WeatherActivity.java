...
//        mSport_text = (TextView) findViewById(R.id.sport_text);
   ...
   //     String imagine_backgroud = preferences.getString("")
...
//                + wetherId + "&7f38cf5c1c614163991cfecccfa65d0d";
    ...
    public void showWeatherInfo(AllData weather){
        ...
        String update_time = weather.allweather.getUpdatetime();
        ...
        mDegretext.setText(weather.allweather.getTemp()+"℃");
